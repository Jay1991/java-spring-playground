...
public class CreateEntitiesDemo {
	...
	private static void createEntities(Session session) {
		...
		Student student1 = createNewStudent(session, "Fulano", "da Silva", "fulano@hotmail.com");
		Student student2 = createNewStudent(session, "Beltrano", "de Souza", "beltrano@gmail.com");
	...
	private static Student createNewStudent(Session session, String firstName, String lastName, String email) {
